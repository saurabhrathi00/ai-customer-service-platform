...
import com.aiassistant.subscription.security.token.TokenPrincipal;
import com.aiassistant.subscription.security.token.TokenProvider;
...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    private static List<String> asStringList(Object value) {
        ...
        if (value instanceof Collection<?> col) return col.stream().filter(Objects::nonNull).map(Object::toString).toList();
